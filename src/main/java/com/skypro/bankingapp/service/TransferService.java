...
public class TransferService {
    ...
    public void transferMoney(TransferRequest transferRequest) {
        if (accountService.getAccount(transferRequest.userFrom(), transferRequest.accountFrom()).currency()
                .equals(
                        accountService.getAccount(transferRequest.userTo(), transferRequest.accountTo()).currency())) {
